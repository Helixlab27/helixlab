                        ...
                        <div className="flex flex-col h-full justify-between">
                            ...
                            <div>
                                ...
                                <p className="text-lg text-black/95 max-w-md pt-4 tracking-tight">
                                    ...
                                    HelixLab transforme votre relation patient après chaque soin,
                                    Messages WhatsApp personnalisés, 
                                    Détection des complications par IA,
                                    Relances RDV — votre clinique reste présente sans y penser.
                                    Vos patients se sentent accompagnés. Votre équipe respire.
                                    Et vos résultats parlent d'eux-mêmes.
                                </p>
                            </div>
                        </div>
                    </div>
